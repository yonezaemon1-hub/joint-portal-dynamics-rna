...
- Creator: Ryutaro Yonezu
- Affiliation: Independent researcher
- License: CC BY 4.0
- Version: 1.2
- Preprint DOI: 10.5281/zenodo.22095413
- Keywords: genotype-phenotype map; neutral network; portal genotype; Wright-Fisher; killed Markov process; first passage; arrival bias; RNA secondary structure
...
- Preprint DOI: https://doi.org/10.5281/zenodo.22095413
- GitHub repository: https://github.com/yonezaemon1-hub/joint-portal-dynamics-rna
- Archived software release v1.1.0 DOI: https://doi.org/10.5281/zenodo.22095082

Scientific results and numerical values are unchanged from v1.1; v1.2 adds permanent publication identifiers.
